...
public class RootCauseAnalyzer {
	...
	public static void main(String[] args) {
		...
		findGEBID("/new_jsassertions/executiontrace/jsexecutiontrace-index20111206185421.dtrace", "");
	}
	...
	public static List<FunctionTrace> extractRelevantSequence(List<List<FunctionTrace>> llft) {
	...
	public static List<FunctionTrace> stitchSequences(List<List<FunctionTrace>> sequences, List<FunctionTrace> relevantSequence) {
	...
	public static String findErrorMsg(String filepath) {
		...
		for (FunctionTrace ft : tp.function_traces) {
			if (ft.f_decl.f_name.substring(ft.f_decl.f_name.lastIndexOf(":::")).equals(":::ERROR")) {
	...
	public static boolean findGEBID(String filepath, String initNullVar) {
		...
		//We're assuming the last trace is always the one corresponding to erroneous line
	...
	public static void testFunctionSequenceParser() {
		...
		//fd_to_compare.ppt_decl = "http://frolinsfilms.110mb.com:80/sample_page.htmlscript0.isOdd:::INTERMEDIATE6";
		fd_to_compare.ppt_decl = "http://frolinsfilms.110mb.com:80/sample_page.htmlscript0.z_func1:::INTERMEDIATE1";
		int index = Collections.binarySearch(tp.function_decls, fd_to_compare, new FunctionDeclComparator());
	...
	public static void testStitchSequences() {
		...
		List<FunctionTrace> stitchedSequence = stitchSequences(sequences, relevantSequence);
	...
	public static void testCompiler() {
		...
		TokenStream ts = ps.initForUnitTest(new StringReader("var y = $('hello'); var x = document.getElementById('hello');"), "", 1, false);
		try {
			//Token t = new Token();
			String t_name = null;
			int token;
	...
	public static void testJSExecute() {
		try {
			...
			//Object result = cx.evaluateString(scope, "x=null;x.innerHTML = 5;", "test_script.js", 1, null);
			Object result = cx.evaluateReader(scope, new FileReader("test_script.js"), "test_script.js", 1, null);
	...
	public static void testGetGEBIDLine() {
		...
		//We're assuming the last trace is always the one corresponding to erroneous line
		//GEBIDLine gebid_line = new GEBIDLine(lft,"find_isOdd","the_elem"); //normally, the null_var is deduced from the error message
		...
		System.out.println("Function (according to trace): " + gebid_line.GEBID_trace.f_decl.f_name);
	...
	public static void testGEBIDLineFinder() {
		...
		//We're assuming the last trace is always the one corresponding to erroneous line
		//GEBIDLineFinder gebid_line = new GEBIDLineFinder("the_elem", lft); //normally, the null_var is deduced from the error message
	...
	public static void testTaskFreak() {
		//TraceParser tp = new TraceParser("taskfreak_execution_trace.dtrace"); //1
		//TraceParser tp = new TraceParser("taskfreak_execution_trace2.dtrace"); //2
		//TraceParser tp = new TraceParser("taskfreak_execution_trace3.dtrace"); //3
		//TraceParser tp = new TraceParser("taskfreak_execution_trace4.dtrace"); //4
		//TraceParser tp = new TraceParser("taskfreak_execution_trace5.dtrace"); //5
		//TraceParser tp = new TraceParser("taskfreak_execution_trace6.dtrace"); //6
		//TraceParser tp = new TraceParser("taskfreak_execution_trace7.dtrace"); //7
		//TraceParser tp = new TraceParser("taskfreak_execution_trace8.dtrace"); //8
		//TraceParser tp = new TraceParser("taskfreak_execution_trace9.dtrace"); //9
		//TraceParser tp = new TraceParser("taskfreak_execution_trace10.dtrace"); //10
		//TraceParser tp = new TraceParser("taskfreak_execution_trace11.dtrace"); //11
		//TraceParser tp = new TraceParser("taskfreak_execution_trace12.dtrace"); //12
		//TraceParser tp = new TraceParser("taskfreak_execution_trace13.dtrace"); //13
		//TraceParser tp = new TraceParser("taskfreak_execution_trace14.dtrace"); //14
		//TraceParser tp = new TraceParser("taskfreak_execution_trace15.dtrace"); //15
		//TraceParser tp = new TraceParser("taskfreak_execution_trace16.dtrace"); //16
		//TraceParser tp = new TraceParser("taskfreak_execution_trace17.dtrace"); //17
		//TraceParser tp = new TraceParser("taskfreak_execution_trace18.dtrace"); //18
		//TraceParser tp = new TraceParser("taskfreak_execution_trace19.dtrace"); //19
		//TraceParser tp = new TraceParser("taskfreak_execution_trace20.dtrace"); //20
		//TraceParser tp = new TraceParser("taskfreak_execution_trace21.dtrace"); //21
		//TraceParser tp = new TraceParser("taskfreak_execution_trace22.dtrace"); //22
		//TraceParser tp = new TraceParser("taskfreak_execution_trace23.dtrace"); //23
		//TraceParser tp = new TraceParser("taskfreak_execution_trace24.dtrace"); //24
		//TraceParser tp = new TraceParser("taskfreak_execution_trace25.dtrace"); //25
		//TraceParser tp = new TraceParser("taskfreak_execution_trace26.dtrace"); //26
		//TraceParser tp = new TraceParser("taskfreak_execution_trace27.dtrace"); //27
		//TraceParser tp = new TraceParser("taskfreak_execution_trace28.dtrace"); //28
	...
	public static void testTudu() {
		...
		//TraceParser tp = new TraceParser("tudu_execution_trace10.dtrace"); //10
		//TraceParser tp = new TraceParser("tudu_execution_trace11.dtrace"); //11
		//TraceParser tp = new TraceParser("tudu_execution_trace12.dtrace"); //12
		//TraceParser tp = new TraceParser("tudu_execution_trace13.dtrace"); //13
		//TraceParser tp = new TraceParser("tudu_execution_trace14.dtrace"); //14
		//TraceParser tp = new TraceParser("tudu_execution_trace15.dtrace"); //15
		//TraceParser tp = new TraceParser("tudu_execution_trace16.dtrace"); //16
		//TraceParser tp = new TraceParser("tudu_execution_trace17.dtrace"); //17
		//TraceParser tp = new TraceParser("tudu_execution_trace18.dtrace"); //18
		//TraceParser tp = new TraceParser("tudu_execution_trace19.dtrace"); //19
		//TraceParser tp = new TraceParser("tudu_execution_trace20.dtrace"); //20
		//TraceParser tp = new TraceParser("tudu_execution_trace21.dtrace"); //21
		//TraceParser tp = new TraceParser("tudu_execution_trace22.dtrace"); //22
		//TraceParser tp = new TraceParser("tudu_execution_trace23.dtrace"); //23
	...
	public static void testWordPress() {
		...
		//GEBIDLineFinder gebid_line = new GEBIDLineFinder("t.Canvas", lft); //6
		//GEBIDLineFinder gebid_line = new GEBIDLineFinder("", lft); //7
		//GEBIDLineFinder gebid_line = new GEBIDLineFinder("", lft); //8
		//GEBIDLineFinder gebid_line = new GEBIDLineFinder("", lft); //9
		//GEBIDLineFinder gebid_line = new GEBIDLineFinder("", lft); //10
